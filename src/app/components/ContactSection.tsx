...
import CvDownload from "./utils/CVDownload";
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">@bonig97</p>
                                    </div>
                                </motion.a> */}
                                <motion.a
                                    href="https://www.linkedin.com/in/gabriele-boni-a87a35141/"
                                    target={"_blank"}
                                    whileHover={{ scale: 1.05 }}
                                    className="flex items-center gap-3 px-4 py-3 bg-gray-100 dark:bg-gray-800/50 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-colors border border-gray-200 dark:border-gray-700/50 group"
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">Gabriele Boni</p>
                                    </div>
                                </motion.a>
                                {/* <motion.a
                                    href="#"
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="font-semibold text-gray-900 dark:text-gray-200">IG</p>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">@hydra971</p>
                                    </div>
                                </motion.a> */}
                            </div>
                        </div>
